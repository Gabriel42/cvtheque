...
const INITIAL_CANDIDATES = [
  ...
  {
    id: 13,
    name: "Fabien Gauthier",
    title: "Program Manager | Operations Manager | PMO Senior",
    city: "Grenoble",
    experience: 23,
    skills: ["Program Management", "PMO", "Projets européens", "Pilotage budgétaire", "CleanTech", "IA", "Coordination multi-acteurs", "Startups"],
    available: true,
    summary: "Ma spécialité, c'est de structurer les écosystèmes multi-acteurs, quand des équipes expertes ont besoin d'un soutien en matière de pilotage pour transformer des initiatives ambitieuses en résultats concrets.\n\nJ'interviens lorsqu'une activité doit changer d'échelle, se professionnaliser ou répondre à des exigences accrues venant des clients, partenaires ou institutions. À ce stade, l'enjeu n'est plus seulement d'innover, mais de rendre l'exécution fiable, lisible et durable.\n\nJ'apporte une rigueur pragmatique, issue de ma formation scientifique et de mon parcours entrepreneurial, me permettant d'analyser avec méthode et de faire évoluer le cadre en fonction des réalités opérationnelles.\n\nAu fil d'un parcours riche dans des environnements technologiques internationaux, j'ai accompagné la croissance d'une startup depuis sa création jusqu'à son rachat, pilotant plus de 40 projets entre leaders du secteur télécoms et assurant le leadership opérationnel d'une équipe de 10 personnes, avant de co-fonder ma propre entreprise.\n\nPar la suite, j'ai piloté un programme européen de plus de 10 M€, impliquant 50+ partenaires dans 12+ pays, structurant sa montée en puissance jusqu'à la création d'un écosystème de 260+ doctorants et plus de 20+ startups créées, pour finalement contribuer au lancement d'une initiative européenne stratégique en IA pour la transition énergétique.",
    email: "fabien.gauthier@laposte.net",
    avatar: "FG",
    category: "support",
    cvUrl: "/pdfs/Fabien_CV_master.pdf",
    pitchUrl: null,
  },
  {
    id: 14,
    name: "Rémi Taillardat",
    title: "Direction Retail Multi-sites | Performance Opérationnelle & Développement Commercial",
    city: "Grenoble",
    experience: 28,
    skills: ["Retail multi-sites", "Performance opérationnelle", "Management réseau", "Pilotage P&L", "Développement commercial", "Conduite du changement", "Category Management"],
    available: true,
    summary: "Mon ADN professionnel, c'est améliorer durablement la performance de réseaux retail en reliant stratégie, terrain et exécution opérationnelle.\n\nJe suis particulièrement utile dans les organisations multi-sites qui doivent structurer leurs pratiques, renforcer leur efficacité commerciale, améliorer leur exécution opérationnelle ou accompagner des transformations.\n\nCe qui me distingue : une double culture terrain et siège qui me permet d'identifier rapidement les leviers de performance, d'aligner les équipes autour d'objectifs communs et de transformer les orientations stratégiques en plans d'actions concrets.\n\nJ'apporte une approche pragmatique fondée sur l'analyse des indicateurs clés, la priorisation des actions et l'accompagnement des équipes jusqu'à l'obtention de résultats durables.\n\nJe le démontre par le pilotage transverse d'un réseau de 30 magasins sur 3 pays, le développement de relais de croissance représentant jusqu'à 30 % du chiffre d'affaires, une amélioration de la marge de +1,8 point, une réduction des ruptures de -20 % et une progression du chiffre d'affaires jusqu'à +56 % en direction de centres de profits.",
    email: "taillardat.remi@gmail.com",
    avatar: "RT",
    category: "commerce",
    cvUrl: "/pdfs/Remi_CV_master.pdf",
    pitchUrl: null,
  },
  {
    id: 11,
